...
export default function InterviewCheatsheetPage() {
  return (
    <main className="cheatsheet">
      ...
      <section className="cheatsheet-section">
        <h2>1) Core patterns (most questions)</h2>
  ...
  right++
      ...
      {/* 2) String problems */}
      <section className="cheatsheet-section">
        <h2>2) String problems — key distinctions</h2>
        <ul>
      ...
      {/* 3) Tokenization */}
      <section className="cheatsheet-section">
        <h2>3) Tokenization + normalization (product FE)</h2>
        <ul>
      ...
      {/* 4) TypeScript tips */}
      <section className="cheatsheet-section">
        <h2>4) TypeScript live-coding tips</h2>
        <ul>
      ...
      {/* 5) Pacing */}
      <section className="cheatsheet-section">
        <h2>5) Interview pacing (45 minutes)</h2>
      ...
      {/* 6) End questions */}
      <section className="cheatsheet-section">
        <h2>6) End-of-interview questions</h2>
        <ul>
